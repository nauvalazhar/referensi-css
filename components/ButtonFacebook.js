export default function ButtonFacebook(props) {
	return (
		<a className="share-button share-button--facebook"
		  href={`https://www.facebook.com/sharer.php?u=${encodeURIComponent(props.url ?? process.env.site.url)}`}
		  data-tooltip-after="Share on Facebook"
		  rel="external nofollow"
		  target="_blank">
			  <svg className="svg svg--facebook" version="1.1" xmlns="https://www.w3.org/2000/svg" xmlnsXlink="https://www.w3.org/1999/xlink" x="0px" y="0px"
